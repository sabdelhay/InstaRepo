class InstagramApi {
    ...
    private let instagramAppID = "761804854950839"
    
    private let redirectURIURLEncoded = "https%3A%2F%2Fstackdeans.com%2F"
    private let redirectURI = "https://stackdeans.com/"
    ...
    private let app_secret = "6da024df51150f9c92f27508f5f034cb"
    ...
    func fetchUser(urlString: String, completion: @escaping (Data?) -> Void) {
        let request = URLRequest(url: URL(string: urlString)!)
